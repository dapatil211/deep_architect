...
class Flat_SSF(SearchSpaceFactory):

    def __init__(self, exp_config):
        SearchSpaceFactory.__init__(self, lambda: flat_search_space(10),
                                    exp_config)


class Hierarchical_SSF(SearchSpaceFactory):

    def __init__(self, exp_config):
        SearchSpaceFactory.__init__(self, lambda: hierarchical_search_space(10),
                                    exp_config)
